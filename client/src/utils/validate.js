...
export const isValidate = (data, type, errors) => {
  ...
  switch (type) {
    ...
    //     dataError.status = 'Please complete this required field!';
    //     error = true;
    //   } else {
    //     dataError.status = '';
    //   }
    ...
    //     dataError.date = 'Please complete this required field!';
    //     error = true;
    //   } else if (data.date.length > 200) {
    //     dataError.date = 'Maximum number of characters allowed: 200';
    //     error = true;
    //   } else {
    //     dataError.date = '';
    //   }
    ...
    //     dataError.birthday = 'Please complete this required field!';
    //     error = true;
    //   } else if (data.birthday.length > 200) {
    //     dataError.birthday = 'Maximum number of characters allowed: 200';
    //     error = true;
    //   } else {
    //     dataError.birthday = '';
    //   }
